...
void *l_caller(long number, void *args)
{
  ...
  switch (number)
  {
    case 0 :
    {
      current_object->set_aistate(lnumber_value(lisp::eval(lisp::car(args))));
    ...
    case 2 :
    {
      ...
      GameObject *o;
      if (args)
        o=(GameObject *)lpointer_value(lisp::eval(lisp::car(args)));
    ...
    case 5 : return LPointer::Create(g_current_level->find_closest(current_object->m_pos.x,
                               ...
                               lnumber_value(lisp::eval(lisp::car(args))),
    ...
    case 7 :
    {
      long n1 = lnumber_value(lisp::eval(lisp::car(args)));
      long n2 = lnumber_value(lisp::eval(lisp::cadr(args)));
    ...
    case 8 :
    {
      int type = lnumber_value(lisp::eval(lisp::car(args))); args=lisp::cdr(args);
      long x = lnumber_value(lisp::eval(lisp::car(args))); args=lisp::cdr(args);
      long y = lnumber_value(lisp::eval(lisp::car(args))); args=lisp::cdr(args);
      GameObject *o;
      if (args)
        o=create(type,x,y,0,lnumber_value(lisp::eval(lisp::car(args))));
      else
        o=create(type,x,y);
      if (g_current_level)
    ...
    case 10 :
    {
      view *v=((GameObject *)lpointer_value(lisp::eval(lisp::car(args))))->m_controller->next;
      if (v)
    ...
    case 11 :
    {
      ...
      ((void *)current_object->get_object(lnumber_value(lisp::eval(lisp::car(args)))));
    } break;
    case 12 :
    {
      return LPointer::Create
      ((void *)current_object->get_light(lnumber_value(lisp::eval(lisp::car(args)))));
    } break;
    case 13 :
    {
      GameObject *old_cur=current_object;
    ...
    {
      ivec2 pos, shift;
      int t = lnumber_value(lisp::eval(lisp::car(args))); args=lisp::cdr(args);
      ...
      int r2 = lnumber_value(lisp::eval(lisp::car(args))); args=lisp::cdr(args);
      int r3 = lnumber_value(lisp::eval(lisp::car(args))); args=lisp::cdr(args);
      shift.x = lnumber_value(lisp::eval(lisp::car(args))); args=lisp::cdr(args);
      shift.y = lnumber_value(lisp::eval(lisp::car(args)));
